		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class="active"><a href="three_column.jsp?type=all">Three Column</a></li>
...
-->
	<h3>Laptops </h3>
        ...
        ResultSet rss=cn.executeQuery("select * from products where category='AC and Fan'");
        while(rss.next()){
                int disc=(d*rss.getInt("price"))/100;
                %>
                        
			<li class="span4">
			  <div class="thumbnail">
				<img src=products/<%=rss.getString("image")%> alt=""></a>
				<div class="caption cntr">
					<p><%=rss.getString("product_name")%></p>
					<p><strong>Rs. <%=rss.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="cart_error.jsp"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					...
					<h4><a class="shopBtn" href="cart_jsp.jsp"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
        ...
        ResultSet rs4=cn.executeQuery("select * from products where category='Mobiles'  ");
        while(rs4.next()){
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><%=rs.getString("product_name")%></p>
					<p><strong>Rs. <%=rs.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="add_to_cart1.jsp?pid=<%=rs.getString("product_id")%>&pname=<%=rs.getString("product_name")%>&price=<%=rs.getString("price")%>&image=<%=rs.getString("image")%>&uid=<%=session.getAttribute("uid")%>&uemail=<%=session.getAttribute("uemail")%>&desc=<%=rs.getString("Product_details")%>&discount=<%out.print(disc);%>" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><%=rss.getString("product_name")%></p>
					<p><strong>Rs. <%=rss.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="add_to_cart1.jsp?pid=<%=rss.getString("product_id")%>&pname=<%=rss.getString("product_name")%>&price=<%=rss.getString("price")%>&image=<%=rss.getString("image")%>&uid=<%=session.getAttribute("uid")%>&uemail=<%=session.getAttribute("uemail")%>&desc=<%=rss.getString("Product_details")%>&discount=<%out.print(disc);%>" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><%=rs1.getString("product_name")%></p>
					<p><strong>Rs. <%=rs1.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="add_to_cart1.jsp?pid=<%=rs1.getString("product_id")%>&pname=<%=rs1.getString("product_name")%>&price=<%=rs1.getString("price")%>&image=<%=rs1.getString("image")%>&uid=<%=session.getAttribute("uid")%>&uemail=<%=session.getAttribute("uemail")%>&desc=<%=rs1.getString("Product_details")%>&discount=<%out.print(disc);%>" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><%=rs2.getString("product_name")%></p>
					<p><strong>Rs. <%=rs2.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="add_to_cart1.jsp?pid=<%=rs2.getString("product_id")%>&pname=<%=rs2.getString("product_name")%>&price=<%=rs2.getString("price")%>&image=<%=rs2.getString("image")%>&uid=<%=session.getAttribute("uid")%>&uemail=<%=session.getAttribute("uemail")%>&desc=<%=rs2.getString("Product_details")%>&discount=<%out.print(disc);%>" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><%=rs3.getString("product_name")%></p>
					<p><strong>Rs. <%=rs3.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="add_to_cart1.jsp?pid=<%=rs3.getString("product_id")%>&pname=<%=rs3.getString("product_name")%>&price=<%=rs3.getString("price")%>&image=<%=rs3.getString("image")%>&uid=<%=session.getAttribute("uid")%>&uemail=<%=session.getAttribute("uemail")%>&desc=<%=rs3.getString("Product_details")%>&discount=<%out.print(disc);%>" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
			...
			<li class="span4">
			  <div class="thumbnail">
				...
				<div class="caption cntr">
					<p><%=rs4.getString("product_name")%></p>
					<p><strong>Rs. <%=rs4.getString("price")%></strong></p>
					<h4><a class="shopBtn" href="add_to_cart1.jsp?pid=<%=rs4.getString("product_id")%>&pname=<%=rs4.getString("product_name")%>&price=<%=rs4.getString("price")%>&image=<%=rs4.getString("image")%>&uid=<%=session.getAttribute("uid")%>&uemail=<%=session.getAttribute("uemail")%>&desc=<%=rs4.getString("Product_details")%>&discount=<%out.print(disc);%>" title="add to cart"> Add to cart </a></h4>
					<div class="actionList">
						 Get <%out.print(d);%>% Discount
					</div> 
					<br class="clr">
